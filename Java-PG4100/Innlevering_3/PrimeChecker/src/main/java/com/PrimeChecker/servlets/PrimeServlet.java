...
public class PrimeServlet extends HttpServlet {
	...
	final static Logger eLogger = Logger.getLogger("luneir14E");
	final static Logger iLogger = Logger.getLogger("luneir14I");
	...
	private void loggingInfo(HttpServletRequest req){
		iLogger.info("Request for number " + req.getParameter("nrToCheck"));
	}
	...
	private void reDirect(HttpServletRequest req, HttpServletResponse resp, String tmp){
		try {
			...
			eLogger.error("Error with servlet: " + e);
		} catch (IOException e) {
			eLogger.error("Error with IO: " + e);
		}
	}
