...
public class ScriptRunner {
     ...
     */
    private void runScript(Connection con, Reader reader) throws IOException,
            SQLException {
        ...
        try {
            ...
            while ((line = lineReader.readLine()) != null) {
                ...
                if (trimmedLine.length() < 1
                    ...
                    command.append(" ");
                    this.execCommand(con, command, lineReader);
                    command = null;
                } else {
                    command.append(line);
                    command.append("\n");
    ...
    private void execCommand(Connection con, StringBuffer command,
